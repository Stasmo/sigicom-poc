...
let appConfig = require('./models/Config').findOne({ name: 'appConfig' })
...
app.get('/search/:searchId', passportConfig.isAuthenticated, searchController.searchResults);
app.post('/search/:searchId/push', passportConfig.isAuthenticated, searchController.pushSearch);
app.get('/config', passportConfig.isAuthenticated, configureController.getConfig);
app.post('/config', passportConfig.isAuthenticated, configureController.postConfig);
